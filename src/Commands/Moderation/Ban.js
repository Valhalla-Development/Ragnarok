import { EmbedBuilder, PermissionsBitField, ButtonBuilder, ActionRowBuilder, ButtonStyle } from 'discord.js';
  ...
  async run(message, args) {
    ...
    if (!user) {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields({ name: `**${this.client.user.username} - Ban**`, value: `**◎ Error:** Run \`${prefix}help ban\` If you are unsure.` });
