					...
					if (args[1] === 'off') {
						if (!status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Birthday function is already disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Birthday function disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					...
					if (args[1] === 'channel') {
						...
						if (args[2] === undefined) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Please mention a channel!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						if (!lchan) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Birthday channel is now set to ${lchan}` });
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Birthday channel updated to ${lchan}` });
							message.channel.send({ embeds: [embed] });
						}
					}
					...
					if (args[1] === 'role') {
						...
						if (!role) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** A role must be mentioned` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Birthday Role updated to ${role}` });
						message.channel.send({ embeds: [embed] });
					}
				}
			}
					...
					if (args[1] === 'disable') {
						if (status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Level system is already disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Level system disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					...
					if (args[1] === 'enable') {
						if (!status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Level system is already enabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Level system enabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						...
						if (activeMenu) {
							...
							try {
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Success:** Specified roles have successfully been removed from the rolemenu!${msg !== '' ? `\n\nThe following roles are **not** in the active rolemenu:\n${msg}` : ''}` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							} catch {
								this.client.utils.messageDelete(message, 10000);
						...
						if (activeMenu) {
							...
							try {
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Success:** Rolemenu has been cleared!` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							} catch {
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
					...
					if (args[1] === 'url') {
						if (args[2] === 'on') {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Hastebin URL blocker was enabled.` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Hastebin URL blocker was disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
				...
				if (message.guild.id) {
					...
					if (args[1] === 'on') {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Dad bot was enabled` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Dad bot was disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
				...
				if (message.guild.id) {
					...
					if (args[1] === 'on') {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Advert protection was enabled` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Advert protection was disabled` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					} else if (args[1] !== 'off' || args[1] !== 'on') {
						this.client.utils.messageDelete(message, 10000);
				...
				if (message.guild.id) {
					...
					if (args[1] === 'off') {
						if (!role) {
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Autorole is already disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Autorole disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
					...
					if (role) {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Autorole updated to \`${args[1]}\`!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
					...
					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Success:** Autorole set to \`${args[1]}\`!` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					return;
				}
			}
				...
				if (message.guild.id) {
					...
					if (args[1] === 'off') {
						...
						if (!status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Logging is already disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Logging disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					...
					if (!status) {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Logging set to ${lchan}` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
					...
					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Success:** Logging updated to ${lchan}` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					return;
				}
			}
				...
				if (args[1] === 'cat') {
					...
					if (message.guild.id) {
						...
						if (args[2] === undefined) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Please type the name of the category!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						if (args[2] === 'off') {
							...
							if (!status) {
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Error:** Ticket Category is already disabled!` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
								return;
							}
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Ticket Category disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					...
					if (message.guild.id) {
						...
						if (args[2] === 'off') {
							...
							if (!status) {
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Error:** Ticket Logging is already disabled!` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
								return;
							}
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Ticket Logging disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						...
						if (!status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Ticket Logging set to ${lchan}` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Ticket Logging updated to ${lchan}` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
				} else if (args[1] === 'role') {
					...
					if (args[2] === 'off') {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Custom Support Role disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
					if (!status) {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Support Role updated to ${suppRole}` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
			...
			if (args[0] === 'prefix') {
				...
				if (talkedRecently.has(message.author.id)) {
					...
					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Error:** Wait 1 minute before changing the prefix again.` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
				} else {
				...
				if (args[1] === 'off') {
					...
					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Success:** Custom prefix disabled!` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					return;
				}
				...
				if (args[1].includes('[') || args[1].includes('{') || args[1].includes(']') || args[1].includes('}') || args[1].includes(':') || args[1].includes('|')) {
					this.client.utils.messageDelete(message, 10000);

					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Error:** Please choose another prefix.` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					return;
				}
						...
						if (args[2] === 'off') {
							...
							if (!status) {
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Error:** Welcome channel is already disabled!` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							} else {
								this.client.utils.messageDelete(message, 10000);
								...
								const embed = new EmbedBuilder()
									.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
									.addFields({ name: `**${this.client.user.username} - Config**`,
										value: `**◎ Success:** Welcome channel disabled!` });
								message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Welcome channel is now set to ${lchan}` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						} else {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Success:** Welcome channel updated to ${lchan}` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						}
					}
				}
				...
				if (message.guild.id) {
					...
					if (args[1] === 'off') {
						...
						if (!status) {
							...
							const embed = new EmbedBuilder()
								.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
								.addFields({ name: `**${this.client.user.username} - Config**`,
									value: `**◎ Error:** Starboard is already disabled!` });
							message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
							return;
						}
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Starboard disabled!` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					...
					if (!status) {
						...
						const embed = new EmbedBuilder()
							.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
							.addFields({ name: `**${this.client.user.username} - Config**`,
								value: `**◎ Success:** Starboard set to ${lchan}` });
						message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
						return;
					}
					...
					const embed = new EmbedBuilder()
						.setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
						.addFields({ name: `**${this.client.user.username} - Config**`,
							value: `**◎ Success:** Starboard updated to ${lchan}` });
					message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
					return;
				}
			}
