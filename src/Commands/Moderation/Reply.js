...
module.exports = class extends Command {
	...
	async run(message, args) {
		...
		function returnValuesFromLink() {
			...
			const exec = mainReg.exec(args[0].toLowerCase()) || ptbReg.exec(args[0].toLowerCase()) || disReg.exec(args[0].toLowerCase()) || ptReg.exec(args[0].toLowerCase()) || caReg.exec(args[0].toLowerCase()) || canApReg.exec(args[0].toLowerCase());
