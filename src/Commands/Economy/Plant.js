    ...
    if (args[0] === 'dm') {
      ...
      if (args[1] === 'off') {
        if (balance.dmHarvest) {
          ...
          const embed = new EmbedBuilder()
            .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
            .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
            .addFields({ name: `**${this.client.user.username} - Plant DM**`, value: '**◎ Error:** You already have DM alerts disabled!' });
          message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
          return;
        }
        ...
        const embed = new EmbedBuilder()
          ...
          .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
          .addFields({
            name: `**${this.client.user.username} - Plant DM**`,
      ...
      if (args[1] === 'on') {
        ...
        const embed = new EmbedBuilder()
          .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
          .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
          .addFields({ name: `**${this.client.user.username} - Plant DM**`, value: '**◎ Error:** You already have harvest alerts enabled!' });
        message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
        return;
      }
    }
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields({
          ...
          value: `**◎ Error:** Incorrect Usage! Available commands:\n\`${prefix}plant corn <amt>\`${
            foundItemList.cornSeeds ? ` - Available Corn seeds: \`${foundItemList.cornSeeds}\`` : ''
          }\n\`${prefix}plant wheat <amt>\`${
            foundItemList.wheatSeeds ? ` - Available Wheat seeds: \`${foundItemList.wheatSeeds}\`` : ''
          }\n\`${prefix}plant potato <amt>\`${
            foundItemList.potatoSeeds ? ` - Available Potato seeds: \`${foundItemList.potatoSeeds}\`` : ''
    ...
    if (args[0] === 'corn') {
      ...
      if (foundPlotList.length + Number(cornAmt) > Number(foundBoostList.farmPlot)) {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            name: `**${this.client.user.username} - Plant**`,
            value: `**◎ Error:** You do not have enough room to plant \`${cornAmt}\` ${
              cornAmt > 1 ? 'seeds.' : 'seed.'
    ...
    if (args[0] === 'wheat') {
      ...
      if (foundPlotList.length + Number(wheatAmt) > Number(foundBoostList.farmPlot)) {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            name: `**${this.client.user.username} - Plant**`,
            value: `**◎ Error:** You do not have enough room to plant \`${wheatAmt}\` ${
              wheatAmt > 1 ? 'seeds.' : 'seed.'
            }\nYour current plot capacity is: \`${foundPlotList.length}\`/\`${Number(foundBoostList.farmPlot)}\``
          });
        message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
        return;
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields({
          name: `**${this.client.user.username} - Plant**`,
          value: `**◎ Success:** You have successfully planted \`${wheatAmt}\` ${
            wheatAmt > 1 ? 'seeds.' : 'seed.'
    ...
    if (args[0] === 'potato') {
      ...
      if (foundPlotList.length + Number(potatoeAmt) > Number(foundBoostList.farmPlot)) {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            name: `**${this.client.user.username} - Plant**`,
            value: `**◎ Error:** You do not have enough room to plant \`${potatoeAmt}\` ${
              potatoeAmt > 1 ? 'seeds.' : 'seed.'
            }\nYour current plot capacity is: \`${foundPlotList.length}\`/\`${Number(foundBoostList.farmPlot)}\``
          });
        message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
        return;
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields({
          name: `**${this.client.user.username} - Plant**`,
          value: `**◎ Success:** You have successfully planted \`${potatoeAmt}\` ${
            potatoeAmt > 1 ? 'seeds.' : 'seed.'
    ...
    if (args[0] === 'tomato') {
      ...
      if (foundPlotList.length + Number(tomatoeAmt) > Number(foundBoostList.farmPlot)) {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            name: `**${this.client.user.username} - Plant**`,
            value: `**◎ Error:** You do not have enough room to plant \`${tomatoeAmt}\` ${
              tomatoeAmt > 1 ? 'seeds.' : 'seed.'
            }\nYour current plot capacity is: \`${foundPlotList.length}\`/\`${Number(foundBoostList.farmPlot)}\``
          });
        message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
        return;
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields({
          name: `**${this.client.user.username} - Plant**`,
          value: `**◎ Success:** You have successfully planted \`${tomatoeAmt}\` ${
            tomatoeAmt > 1 ? 'seeds.' : 'seed.'
