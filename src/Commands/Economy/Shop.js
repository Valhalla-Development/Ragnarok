  ...
  async run(message, args) {
    ...
    if (!args.length) {
      const embed = new EmbedBuilder()
        ...
        .addFields({
          name: `**${this.client.user.username} - Shop**`,
      ...
      if (args[1] === undefined) {
        ...
        if (foundBoostList.seedBag) {
          if (Number(foundBoostList.seedBag) < Number(seedBagMax)) {
            ...
            arr.push(
              `\u3000 \`${prefix}shop upgrade seedbag\` - <:coin:706659001164628008> \`${upgradeSeedBag.toLocaleString(
                'en'
        ...
        if (foundBoostList.fishBag) {
          if (Number(foundBoostList.fishBag) < Number(fishBagMax)) {
            ...
            arr.push(
              `\u3000 \`${prefix}shop upgrade fishbag\` - <:coin:706659001164628008> \`${upgradeFishBag.toLocaleString(
                'en'
        ...
        if (foundBoostList.farmBag) {
          if (Number(foundBoostList.farmBag) < Number(farmBagMax)) {
            ...
            arr.push(
              `\u3000 \`${prefix}shop upgrade farmbag\` - <:coin:706659001164628008> \`${upgradeFarmBag.toLocaleString(
                'en'
        ...
        if (foundBoostList.farmPlot) {
          if (Number(foundBoostList.farmPlot) < Number(farmPlotMax)) {
            ...
            arr.push(
              `\u3000 \`${prefix}shop upgrade plot\` - <:coin:706659001164628008> \`${upgradeFarmPlot.toLocaleString(
                'en'
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `**◎ Farming Seeds: (Amount optional)**
						\u3000 \`${prefix}shop buy corn [amount]\` - 10 Seeds per pack - ${
              !foundItemList.cornSeeds
                ...
                : `<:coin:706659001164628008> \`${cornSeedPrice.toLocaleString('en')}\` - \`Owned ${foundItemList.cornSeeds.toLocaleString('en')}\``
						...
						\u3000 \`${prefix}shop buy wheat [amount]\` - 10 Seeds per pack - ${
              !foundItemList.wheatSeeds
                ...
                : `<:coin:706659001164628008> \`${wheatSeedPrice.toLocaleString('en')}\`- \`Owned ${foundItemList.wheatSeeds.toLocaleString('en')}\``
						...
						\u3000 \`${prefix}shop buy potato [amount]\` - 10 Seeds per pack - ${
              !foundItemList.potatoSeeds
                ...
                : `<:coin:706659001164628008> \`${potatoeSeedPrice.toLocaleString('en')}\`- \`Owned ${foundItemList.potatoSeeds.toLocaleString(
                    'en'
						...
						\u3000 \`${prefix}shop buy tomato [amount]\` - 10 Seeds per pack - ${
              ...
              !foundItemList.fishingRod
                ? `\`${prefix}shop buy rod\` - <:coin:706659001164628008> \`${fishingPrice.toLocaleString('en')}\``
                : 'Fishing Rod - `Owned`'
            }
						\u3000 Fish Bag - ${
              !foundBoostList.fishBag
              ...
              !foundItemList.farmingTools
                ? `\`${prefix}shop buy tools\` - <:coin:706659001164628008> \`${farmingPrice.toLocaleString('en')}\``
                : 'Farming Tools - `Owned`'
            }
						\u3000 Seed Bag - ${
              !foundBoostList.seedBag
      ...
      if (args[1] === 'corn') {
        ...
        if (cornAmt <= 0) {
          ...
          const embed = new EmbedBuilder()
            .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
            .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
            .addFields({ name: `**${this.client.user.username} - Shop - Corn Seeds**`, value: '**◎ Error:** Please enter a valid number.' });
          message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
          return;
        }

        if (Number.isNaN(cornAmt)) {
          this.client.utils.messageDelete(message, 10000);
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `**◎ Success:** You have bought a pack of Corn Seeds.\nYou now have \`${calc}\` total Corn seeds.\n\nYour current backpack capacity is at \`${
              Number(currentTotalSeeds) + Number(cornAmt) * 10
            }\`/\`${foundBoostList.seedBag}\``
          });
      ...
      if (args[1] === 'wheat') {
        ...
        if (wheatAmt <= 0) {
          ...
          const embed = new EmbedBuilder()
            .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
            .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
            .addFields({ name: `**${this.client.user.username} - Shop - Wheat Seeds**`, value: '**◎ Error:** Please enter a valid number.' });
          message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
          return;
        }

        if (Number.isNaN(wheatAmt)) {
          this.client.utils.messageDelete(message, 10000);
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `**◎ Success:** You have bought a pack of Wheat Seeds.\nYou now have \`${calc}\` total Wheat seeds.\n\nYour current backpack capacity is at \`${
              Number(currentTotalSeeds) + Number(wheatAmt) * 10
            }\`/\`${foundBoostList.seedBag}\``
          });
      ...
      if (args[1] === 'potato') {
        ...
        if (potatoeAmt <= 0) {
          ...
          const embed = new EmbedBuilder()
            .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
            .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
            .addFields({ name: `**${this.client.user.username} - Shop - Potato Seeds**`, value: '**◎ Error:** Please enter a valid number.' });
          message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
          return;
        }

        if (Number.isNaN(potatoeAmt)) {
          this.client.utils.messageDelete(message, 10000);
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `**◎ Success:** You have bought a pack of Potato Seeds.\nYou now have \`${calc}\` total Potato seeds.\n\nYour current backpack capacity is at \`${
              Number(currentTotalSeeds) + Number(potatoeAmt) * 10
            }\`/\`${foundBoostList.seedBag}\``
          });
      ...
      if (args[1] === 'tomato') {
        ...
        if (tomatoeAmt <= 0) {
          ...
          const embed = new EmbedBuilder()
            .setAuthor({ name: `${message.author.tag}`, iconURL: message.author.avatarURL() })
            .setColor(this.client.utils.color(message.guild.members.me.displayHexColor))
            .addFields({ name: `**${this.client.user.username} - Shop - Tomato Seeds**`, value: '**◎ Error:** Please enter a valid number.' });
          message.channel.send({ embeds: [embed] }).then((m) => this.client.utils.deletableCheck(m, 10000));
          return;
        }

        if (Number.isNaN(tomatoeAmt)) {
          this.client.utils.messageDelete(message, 10000);
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `**◎ Success:** You have bought a pack of Tomato Seeds.\nYou now have \`${calc}\` total Tomato seeds.\n\nYour current backpack capacity is at \`${
              Number(currentTotalSeeds) + Number(tomatoeAmt) * 10
            }\`/\`${foundBoostList.seedBag}\``
          });
