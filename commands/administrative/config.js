    ...
    run: async (bot, message, args, color) => {
        ...
        if (args[0] === "rolemenu") {
            ...
            if ((!message.member.hasPermission("MANAGE_GUILD") && (message.author.id !== ownerID))) {
                let invalidpermsembed = new MessageEmbed()
                    .setColor(`36393F`)
            ...
            if (args[1] === 'add') {
                ...
                let incorrectUsageembed = new MessageEmbed()
                    .setColor(`36393F`)
            ...
            if (message.guild.id) {
                ...
                if (args[1] === "on") {
                    ...
                    if (status) {
                        ...
                        let alreadyonembed = new MessageEmbed()
                            .setColor(`36393F`)
                        ...
                        let turnonembed = new MessageEmbed()
                            .setColor(`36393F`)
                    ...
                    if (!status) {
                        ...
                        let alreadyoffembed = new MessageEmbed()
                            .setColor(`36393F`)
                        ...
                        let turnedoffembed = new MessageEmbed()
                            .setColor(`36393F`)
                    ...
                    let incorrectembed = new MessageEmbed()
                        .setColor(`36393F`)
                        .setDescription(`${incorrectUsage}`);
        ...
        if (args[0] === "autorole") {
            ...
            if (message.guild.id) {
                ...
                if (!args[1]) {
                    ...
                    let turnoffembed = new MessageEmbed()
                        .setColor(`36393F`)
        ...
        if (args[0] === "ticket") {
            if (args[1] === "cat") {
                ...
                bot.getTable = db.prepare("SELECT category FROM ticketConfig WHERE guildid = ?");
                ...
                bot.getTable = db.prepare("SELECT log FROM ticketConfig WHERE guildid = ?");
                ...
                bot.getTable = db.prepare("SELECT role FROM ticketConfig WHERE guildid = ?");
                let status = bot.getTable.get(message.guild.id);
